...
public class FileSender {
    ...
    public FileSender(File file, Socket socket, SendMessage message) throws FileNotFoundException, IOException {
    ...
    private void sendingFile() throws IOException{
        PackageSender data = new PackageSender();
                    ...
                    if(act){
                        try {
                            if(!data.isFinish()){
                                ...
                                Service.getInstance().fileSendFinish(FileSender.this);
                            }
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
